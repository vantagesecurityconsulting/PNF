...
export default function DriverTrips() {
  ...
  return (
    <div className="mx-auto max-w-xl space-y-4">
      <h1 className="text-2xl font-black tracking-tight text-white">Today's Trips</h1>
              ...
              <Card key={trip.id} padded={false} className="overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-extrabold text-white">Trip {trip.tripNumber}</div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <div className="flex items-center gap-1 tabular text-sm font-bold text-white">
                ...
                {open && (
                  <div className="border-t border-line bg-offwhite/50 px-5 py-4">
  ...
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      <input
        ...
        className="tabular h-10 rounded-lg border border-line bg-surface px-3 font-semibold text-white outline-none focus:border-green"
      />
    </div>
  )
}
...
function TotalCard({ icon: Icon, label, value }) {
  return (
    <div className="rounded-2xl bg-surface px-3 py-3 text-center shadow-card">
      ...
      <div className="tabular mt-1 text-2xl font-black text-white">{value}</div>
